...
-- DropForeignKey
ALTER TABLE "orderItems" DROP CONSTRAINT "orderItems_sellerId_fkey";
...
-- AddForeignKey
ALTER TABLE "orderItems" ADD CONSTRAINT "orderItems_sellerId_fkey" FOREIGN KEY ("sellerId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE;
